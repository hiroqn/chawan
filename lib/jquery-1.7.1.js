...
(function(window, undefined) {
  ...
  var jQuery = (function() {
    ...
    hasOwn = Object.prototype.hasOwnProperty, push = Array.prototype.push, 
          ...
          sub : function() {
            ...
            jQuerySub.fn.init = function init(selector, context) {
              ...
              return jQuery.fn.init
                  .call(this, selector, context, rootjQuerySub);
            };
      ...
      .extend({
        ...
        when : function(firstParam) {
          ...
          function progressFunc(i) {
            return function(value) {
              pValues[i] = arguments.length > 1 ? sliceDeferred.call(arguments,
                  0) : value;
      ...
      if (typeof data === "string") {
        try {
          data = data === "true" ? true : data === "false" ? false
              : data === "null" ? null
                  : jQuery.isNumeric(data) ? parseFloat(data) : rbrace
        ...
        promise : function(type, object) {
          ...
          while (i--) {
            if ((tmp = jQuery.data(elements[i], deferDataKey, undefined, true)
                || (jQuery.data(elements[i], queueDataKey, undefined, true) || jQuery
                    .data(elements[i], markDataKey, undefined, true))
  ...
  boolHook = {
    ...
    set : function(elem, value, name) {
      ...
      if (value === false) {
        ...
        // value is true since we know at this point it's type boolean and not
        // false
  ...
  if (!getSetAttribute) {
    ...
    nodeHook = jQuery.valHooks.button = {
      get : function(elem, name) {
        ...
        return ret
            && (fixSpecified[name] ? ret.nodeValue !== "" : ret.specified) ? ret.nodeValue
            : undefined;
      },
      set : function(elem, value, name) {
  ...
  jQuery.event = {
    ...
    dispatch : function(event) {
      ...
      var handlers = ((jQuery._data(this, "events") || {})[event.type] || []), delegateCount = handlers.delegateCount, args = [].slice
          .call(arguments, 0), run_all = !event.exclusive && !event.namespace, handlerQueue = [], i, j, cur, jqcur, ret, selMatch, matched, matches, handleObj, sel, related;
        ...
        for (cur = event.target; cur != this; cur = cur.parentNode || this) {
          ...
          for (i = 0; i < delegateCount; i++) {
            ...
            if (selMatch[sel] === undefined) {
              selMatch[sel] = (handleObj.quick ? quickIs(cur, handleObj.quick)
                  : jqcur.is(sel));
            }
            if (selMatch[sel]) {
          ...
          if (types && types.preventDefault && types.handleObj) {
            ...
            jQuery(types.delegateTarget).off(
                handleObj.namespace ? handleObj.type + "."
                    + handleObj.namespace : handleObj.type, handleObj.selector,
                handleObj.handler);
            return this;
          }
          if (typeof types === "object") {
    ...
    var Expr = Sizzle.selectors = {
      ...
      filter : {
        ...
        ATTR : function(elem, match) {
          var name = match[1], result = Sizzle.attr ? Sizzle.attr(elem, name)
              : Expr.attrHandle[name] ? Expr.attrHandle[name](elem)
  ...
  jQuery.fn
      .extend({
        ...
        closest : function(selectors, context) {
          ...
          // String
          var pos = POS.test(selectors) || typeof selectors !== "string" ? jQuery(
      ...
      if (this[0]) {
        ...
        if (first) {
          ...
          for ( var i = 0, l = this.length, lastIndex = l - 1; i < l; i++) {
            ...
            // used
            // in place.
            results.cacheable || (l > 1 && i < lastIndex) ? jQuery.clone(
  ...
  function root(elem, cur) {
    return jQuery.nodeName(elem, "table") ? (elem.getElementsByTagName("tbody")[0] || elem
  ...
  jQuery.buildFragment = function(args, nodes, scripts) {
    ...
    if (args.length === 1 && typeof first === "string" && first.length < 512
        && doc === document && first.charAt(0) === "<" && !rnocache.test(first)
      ...
      .extend({
        clone : function(elem, dataAndEvents, deepDataAndEvents) {
          ...
          clone = jQuery.support.html5Clone
              || !rnoshimcache.test("<" + elem.nodeName) ? elem.cloneNode(true)
              : shimCloneNode(elem);
          ...
          return this
              ...
              .filter(
                  function() {
                    return this.name
                        && !this.disabled
                        && (this.checked || rselectTextarea.test(this.nodeName) || rinput
                            .test(this.type));
                  }).map(
                  function(i, elem) {
  ...
  jQuery.fn
      .extend({
        ...
        animate : function(prop, speed, easing, callback) {
          ...
          function doAnimation() {
            ...
            for (p in prop) {
              ...
              if (rfxtypes.test(val)) {
                ...
                if (method) {
                  jQuery._data(this, "toggle" + p, method === "show" ? "hide"
                      : "show");
                  e[method]();
                } else {
                  e[val]();
          ...
          return optall.queue === false ? this.each(doAnimation) : this.queue(
  ...
  function defaultDisplay(nodeName) {
    ...
    if (!elemdisplay[nodeName]) {
      ...
      var body = document.body, elem = jQuery("<" + nodeName + ">").appendTo(
          body), display = elem.css("display");
      elem.remove();
  ...
  jQuery.each([ "Left", "Top" ], function(i, name) {
    ...
    jQuery.fn[method] = function(val) {
      ...
      return this.each(function() {
        ...
        if (win) {
          win.scrollTo(!i ? val : jQuery(win).scrollLeft(), i ? val : jQuery(
              win).scrollTop());
      ...
      .each(
          ...
          function(i, name) {
            ...
            jQuery.fn["outer" + name] = function(margin) {
              var elem = this[0];
              return elem ? elem.style ? parseFloat(jQuery.css(elem, type,
                  margin ? "margin" : "border")) : this[type]() : null;
            };
